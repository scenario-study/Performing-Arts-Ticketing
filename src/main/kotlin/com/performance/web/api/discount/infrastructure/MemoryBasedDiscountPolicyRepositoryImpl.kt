...
class MemoryBasedDiscountPolicyRepositoryImpl : DiscountPolicyRepository {
    ...
    private final val discountPolicyStore =
        ConcurrentHashMap<Long, DiscountPolicy>(
            mapOf(
                1L to
    ...
    override fun findById(id: Long): Optional<DiscountPolicy> = Optional.ofNullable(discountPolicyStore[id])
}
